...
const server = new index_js_1.Server({ name: 'section8-market-status', version: '1.0.0' }, { capabilities: { tools: {} } });
...
server.setRequestHandler(types_js_1.CallToolRequestSchema, async (request) => {
    ...
    if (name === 'parse_market_status') {
        ...
        if (status === 'unknown') {
            ...
            if (status === 'unknown' && (lower.includes('for sale') ||
